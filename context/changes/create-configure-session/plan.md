...
- [x] 2.4 gRPC endpoint reachable from the running app — a69621a
- [x] 2.5 Editing an activated session is rejected (FailedPrecondition surfaced, not silent) — a69621a
...
- [x] 3.3 Signed-in user creates a session with ad-hoc tasks + a scale; it appears in the list — a69621a
- [x] 3.4 Importing ADO work items snapshots selected items (when ADO configured) — a69621a
- [x] 3.5 Draft session reconfigurable; after Activate config controls disable — a69621a
- [x] 3.6 Page renders correctly in English and Polish — a69621a

### Phase 4: End-to-End Test

#### Automated

- [x] 4.1 Build + Playwright browsers installed — a69621a
- [x] 4.2 E2E test passes locally: SessionsTests — a69621a
- [x] 4.3 Full suite green: `dotnet test PlanDeck.slnx` — a69621a

#### Manual

- [x] 4.4 E2E run boots Aspire, creates a session, assertion stable across reruns — a69621a
